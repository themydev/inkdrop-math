...
var _default = {
  ...
  "\\dmat"(ctx) {
    const fill = (0, _util.getSqureParameter)(ctx);
    const elements = (0, _util.popNextArg)(ctx).split(",");
    const lines = [];
  ...
  "\\imat"(ctx) {
    const n = parseInt((0, _util.popNextArg)(ctx));
  ...
  "\\xmat"(ctx) {
    const labeled = (0, _util.isAlt)(ctx);
    const [x, n, m] = [(0, _util.popNextArg)(ctx), parseInt((0, _util.popNextArg)(ctx)), parseInt((0, _util.popNextArg)(ctx))];
